package at.ait.dme.yuma4j.server.gui.documentation;

import org.apache.wicket.PageParameters;
import org.apache.wicket.markup.html.basic.Label;

import at.ait.dme.yuma4j.server.config.ServerConfig;
import at.ait.dme.yuma4j.server.gui.BaseTextPage;
...
public class API extends BaseTextPage {
	...
	private static final String BASE_URL = ServerConfig.getInstance().getServerBaseURL() + "api/";
